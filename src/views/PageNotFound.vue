<template>
<!-- ====== 404 Section Start -->
<section class="bg-white py-14 lg:py-20 my-16">
    <div class="container">
            ...
            <div class="w-full px-4">
                <div class="wow fadeInUp relative mx-auto max-w-[850px] overflow-hidden rounded-lg bg-white py-20 px-8 text-center shadow-lg sm:px-12 md:px-[60px]"
                    ...
                    <ul class="flex flex-wrap justify-center">
                        <li>
                           <router-link to="/"
                                class="mx-2 my-1 inline-block rounded-md bg-primary py-3 px-6 text-base font-medium text-white hover:bg-body-color hover:text-white transition duration-300 ease-in-out">
                                Home
                            </router-link>
                        </li>

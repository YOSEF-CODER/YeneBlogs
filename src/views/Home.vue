...
<!-- ====== Hero Section Start -->
<div id="home" class="relative overflow-hidden bg-black pt-[120px] md:pt-[130px] lg:pt-[160px]">
  <div class="container">
      ...
      <div class="w-full px-4">
        <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
          ...
          <p
            ...
            Multidisciplinary Web Template Built with Your Favourite Technology - HTML Bootstrap, Tailwind and React
            NextJS.
          </p>
          <ul class="flex flex-wrap items-center justify-center mb-10">
            <li>
              <router-link to="/blogs"
                class="inline-flex items-center justify-center px-6 py-4 text-base font-medium text-center transition duration-300 ease-in-out text-red hover:bg-slate-500 hover:text-white rounded-lg bg-white text-primary sm:px-10">
                Explore
              </router-link>
            </li>
            <li>
...
<!-- ====== About Section Start -->
<about-us-vue></about-us-vue>
<!-- ====== About Section End -->

<!-- ====== Pricing Section Start -->
<section id="pricing" class="relative z-20 overflow-hidden bg-[#F3F4FE] pt-8 pb-12 lg:pb-[90px]">
  <div class="container">
      <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <p class="text-base text-body-color md:text-lg">
  ...
  <div class="flex gap-4 justify-center flex-wrap my-16">
    <blog-card :post="post" v-for="(post,index) in sampleBlogCards" :key="index" class="w-72">
</blog-card>
    </div>

  <router-link to="/blogs"
    class="block text-center px-3 py-3 font-medium w-40 my-10 mx-auto transition duration-300 ease-in-out rounded bg-primary hover:bg-opacity-90 hover:shadow-lg">
...
<!-- ====== Testimonials Start ====== -->
<testimonial-vue></testimonial-vue>
<!-- ====== Testimonials End ====== -->
...
<script>
import HowToVue from '../components/UI/HowTo.vue';
import Contact from '../components/UI/Contact.vue'
import AboutUsVue from '../components/UI/AboutUs.vue';
import Team from '../components/UI/Team.vue'
import TestimonialVue from '../components/UI/TestimonialVue.vue'
  ...
  data() {
    return {
      sampleBlogCards: [
        ...
        { blogTitle: "Blog Card #1", blogCoverPhoto: "stock-2", blogDate: "May 1. 2021" },
        { blogTitle: "Blog Card #1", blogCoverPhoto: "stock-3", blogDate: "May 1. 2021" },
         {blogTitle: "Blog Card #1", blogCoverPhoto: "stock-4", blogDate: "May 1. 2021"}
      ]
         }
  },
};

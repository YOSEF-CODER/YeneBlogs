<template>
  <footer class="relative w-full pt-20 pb-10 text-white bg-primary lg:pt-20 lg:pr-20 lg:pl-20 lg:pb-10">
    <div class="container border-b border-body-color">
      <div class="flex flex-wrap mx-4">
        <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
          <div class="w-full mb-10">
            <router-link to="/about" class="inline-block max-w-[160px] mb-6">
              <img src="../assets/images/logo/logo.png" alt="ARL logo" style="w-1/4" />
          </router-link>
            ...
            <p class="flex items-center text-sm font-medium text-dark">
              ...
              <span class="text-white">+012 (345) 678 99</span>
            </p>
          </div>
        </div>
        <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
          <div class="w-full mb-10">
            <h4 class="w-8 border-b border-body-color"></h4>
            <h4 class="mt-2 text-lg font-semibold text-base-100 mb-9">Resources</h4>
            <ul>
              <li>
                <a href="javascript:void(0)" class="inline-block mb-2 leading-loose text-base-100 hover:text-primary">
                  SaaS Development
                </a>
              </li>
              <li>
                <a href="javascript:void(0)"
                  class="inline-block mb-2 text-base leading-loose text-base-100 hover:text-primary">
                  Our Products
                </a>
              </li>
              <li>
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
          <div class="w-full mb-10">
            <h4 class="w-8 border-b border-body-color"></h4>
            <h4 class="mt-2 text-lg font-semibold text-base-100 mb-9">Company</h4>
            <ul>
              <li>
                <a href="javascript:void(0)"
                  class="inline-block mb-2 text-base leading-loose text-base-100 hover:text-primary">
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
          <div class="w-full mb-10">
            <h4 class="w-8 border-b border-body-color"></h4>
            <h4 class="mt-2 text-lg font-semibold text-base-100 mb-9">Quick Links</h4>
            <ul>
              <li>
                <a href="javascript:void(0)"
                  class="inline-block mb-2 text-base leading-loose text-base-100 hover:text-primary">
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
          <div class="w-full mb-10">
            <h4 class="w-8 border-b border-body-color"></h4>
            <h4 class="mt-2 text-lg font-semibold text-base-100 mb-9">Follow Us On</h4>
            <div class="flex items-center mb-6">
              <a href="javascript:void(0)" class="
                     ...
                     text-base-100
                     hover:text-base-100 hover:bg-primary hover:border-primary
                     mr-3
                     sm:mr-4
                     lg:mr-3
                     xl:mr-4
    ...
    <div class="pt-10 text-sm text-center p-y-10 text-white dark:text-gray-400">© 2022 Addis Ababa Science and
      Technology
      University
      and
      Alpha

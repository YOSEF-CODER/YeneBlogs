<template>
    ...
    <section id="testimonials" class="pt-20 md:px-16 md:py-2 mt-20">
        ...
        <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            ...
            <p class="text-base text-dark md:text-lg">
            ...
            <div class="flex flex-wrap">
                <div class="w-full px-4 md:w-1/2 lg:w-1/3 ">
                    <div class="p-8 mb-12 transition duration-300 transform shadow-xl ud-single-testimonial wow fadeInUp bg-teal-light shadow-testimonial rounded-xl lg:hover:-translate-y-4"
                        data-wow-delay=".1s
                  ">
